...
public class Session {
	 ...
	 */
	public static final int MAX_INACTIVITY = 60;//最大响应时间

	/**
	 * Maximum number of simultaneous requests allowed.
	 */
	public static final int MAX_REQUESTS = 500;//最大并发连接
	 ...
	 * network failure.
	 */
	public static final int MAX_WAIT = 3000;//最大等待时间

	/**
	 * Shortest allowable polling interval (in seconds).
	 */
	public static final int MIN_POLLING = 20;
